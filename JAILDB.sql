...
CREATE TABLE `POLICEOFFICER` (
	...
	PRIMARY KEY (`POId`),
	FOREIGN KEY (`POJailId`) REFERENCES `JAIL` (`JId`) DELETE CASCADE,
...
CREATE TABLE `DEPARTMENT` (
	...
	FOREIGN KEY (`DHeadId`) REFERENCES `POLICEOFFICER` (`POId`) DELETE CASCADE,
	FOREIGN KEY (`DJailId`) REFERENCES `JAIL` (`JId`) DELETE CASCADE,
	UNIQUE (`DHeadId`),
	-- UNIQUE (`DName`)
)ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `PRISONER` (
	...
	PRIMARY KEY (`PId`),
	FOREIGN KEY (`PDname`,`PJailId`) REFERENCES `DEPARTMENT` (`DName`,`DJailId`) DELETE CASCADE
)ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `CRIME` (
	...
	FOREIGN KEY (`CPId`) REFERENCES `PRISONER` (`PId`) DELETE CASCADE
)ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `VISITOR` (
	...
	FOREIGN KEY (`VPId`) REFERENCES `PRISONER` (`PId`) DELETE CASCADE
)ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `PWORKSFOR` (
	...
	PRIMARY KEY (`PId`),
	FOREIGN KEY (`PId`) REFERENCES `PRISONER` (`PId`) DELETE CASCADE,
	-- FOREIGN KEY (`JId`) REFERENCES `JAIL` (`JId`) DELETE CASCADE,
...
CREATE TABLE `JWORKSFOR` (
	...
	FOREIGN KEY (`JId`) REFERENCES `JAIL` (`JId`) DELETE CASCADE,
	FOREIGN KEY (`POId`) REFERENCES `POLICEOFFICER` (`POId`) DELETE CASCADE,
...
CREATE TABLE `VISITORCONTACT` (
	...
	FOREIGN KEY (`VPId`,`VFName`) REFERENCES `VISITOR` (`VPId`,`VFName`) DELETE CASCADE,
	-- FOREIGN KEY (`VFName`) REFERENCES `VISITOR` (`VFName`),
...
CREATE TABLE `POLICEOFFICEREMAIL` (
	...
	FOREIGN KEY (`POId`) REFERENCES `POLICEOFFICER` (`POId`) 
)ENGINE=InnoDB DEFAULT CHARSET=latin1;

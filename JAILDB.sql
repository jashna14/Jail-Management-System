...
CREATE TABLE `PRISONER` (
	...
	PRIMARY KEY (`PId`),
	FOREIGN KEY (`PDname`) REFERENCES `DEPARTMENT` (`Dname`),
	FOREIGN KEY (`PJailId`) REFERENCES `JAIL` (`JId`)
...
INSERT INTO `PRISONER` VALUES (125,'Naman','Baheti',1,'Toilet Cleaning','Katra No. 5,Lahore',14,'2000-02-29','2018-03-15');
-- (128,'Sajal','Khandelwal',2,'Kitchen','Raj Mahal No. 3,Alwar',5,'2001-05-25','2018-04-02');
...
CREATE TABLE `POLICEOFFICER` (
	...
	PRIMARY KEY (`POId`),
	FOREIGN KEY (`POJailId`) REFERENCES `JAIL` (`JId`),
...
CREATE TABLE `CRIME` (
	...
	FOREIGN KEY (`CPId`) REFERENCES `PRISONER` (`PId`)
)ENGINE=InnoDB DEFAULT CHARSET=latin1;
;
...
CREATE TABLE `DEPARTMENT` (
	...
	FOREIGN KEY (`DHeadId`) REFERENCES `POLICEOFFICER` (`POId`),
	FOREIGN KEY (`DJailId`) REFERENCES `JAIL` (`JId`),
	UNIQUE (`DHeadId`)
)ENGINE=InnoDB DEFAULT CHARSET=latin1;
;
...
CREATE TABLE `VISITOR` (
	...
	FOREIGN KEY (`VPId`) REFERENCES `PRISONER` (`PId`),
)ENGINE=InnoDB DEFAULT CHARSET=latin1;
;
...
CREATE TABLE `VISITORCONTACT` (
	...
	FOREIGN KEY (`VPId`) REFERENCES `VISITOR` (`VPId`),
...
CREATE TABLE `POLICEOFFICERCONTACT` (
	...
	FOREIGN KEY (`POId`) REFERENCES `POLICEOFFICERCONTACT` (`POId`),
